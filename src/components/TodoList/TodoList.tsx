...
import { FilterValuesType, TodoListType, tasksState } from "constants/types"
import AddItemForm from "../AddItemForm/AddItemForm"
import { addTaskTC, getTasksTC, tasksActions } from "store/slices/tasks.slice"
import { removeTodoTC, todoListsActions } from "store/slices/todoLists.slice"
...
const TodoList: FC<TodoListProps> = React.memo((props) => {
    const tasksState = useSelector<RootStateType, tasksState>((state) => state.tasks)
